...
@Composable
fun StackoverflowExpandableText(
    ...
    collapsedMaxLine: Int = Contains.DEFAULT_MINIMUM_TEXT_LINE,
...
@Preview
@Composable
fun StackoverflowExpandableTextPreview() {
    StackoverflowExpandableText(text = "")
}